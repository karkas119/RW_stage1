...
class MovieItem1 extends React.Component {
    ...
    handleLike = () => {
        ...
        WillWatch.push("Avengers: Infinity War");
        console.log(WillWatch);
    };
    render(){
        const { data: {title, vote_average, poster_path }} = this.props;
        return(
    ...
    render(){
        ...
        return(
            <div className='col-4 mb-4' style = {{float:"left", width:"300px"}}>
                ...
                <div style = {{display:"flex", justifyContent:"space-between"}}>
                    <button type="button" onClick={this.handleLike}
                            className={this.state.like ? "btn--like" : "" }>Will watch</button>
                </div>
            </div>
...
class MovieItem10 extends React.Component {
    ...
    handleLike = () => {
        ...
        WillWatch.push("How to Talk to Girls at Parties");
        console.log(WillWatch);
    };
    render(){
        const { data: {title, vote_average, poster_path }} = this.props;
...
class MovieItem15 extends React.Component {
    ...
    handleLike = () => {
        ...
        WillWatch.push("The Invisible Guest");
        console.log(WillWatch);
    };
    render(){
        const { data: {title, vote_average, poster_path }} = this.props;
...
class WillWatchShow extends React.Component{
    render(){
        return(
            <div className={"movie1_show"}>{WillWatch}</div>
        )
    }
}
